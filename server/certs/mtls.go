...
// MtlsC2ServerGenerateRSACertificate - Generate a server certificate signed with a given CA
...
func MtlsC2ImplantGenerateRSACertificate(name string) ([]byte, []byte, error) {
